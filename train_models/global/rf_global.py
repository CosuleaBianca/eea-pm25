...
OUTPUT_METRICS_PATH = "results/rf_metrics_tuned.csv"
OUTPUT_PREDS_PATH = "results/rf_predictions_sample.csv"
OUTPUT_BEST_PARAMS_JSON = "train_models/global/rf_best_params_by_horizon.json"
OUTPUT_RUN_INFO_JSON = "train_models/global/runs_info/rf_run_info.json"

MODEL_DIR = "models/models_rf"
...
def get_or_tune_best_params(
    ...
    if os.path.exists(json_path):
        ...
        best_params_by_h = run_hyperparameter_optimization(train_df_base, feature_cols, horizons)
...
def main():
    ...
    best_params_by_h = get_or_tune_best_params(train_df_base, feature_cols, HORIZONS, OUTPUT_BEST_PARAMS_JSON)
