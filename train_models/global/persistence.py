...
OUTPUT_METRICS_PATH = "results/persistence_metrics.csv"
OUTPUT_PREDS_PATH = "results/persistence_predictions_sample.csv"
RUN_INFO_PATH = "train_models/global/runs_info/persistence_run_info.json"
