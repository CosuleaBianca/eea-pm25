...
OUTPUT_METRICS_PATH = "results/gam_split_2_metrics_tuned.csv"
OUTPUT_PREDS_PATH = "results/gam_split_2_predictions_sample.csv"
OUTPUT_BEST_PARAMS_JSON = "train_models/global/gam_split_2_best_params_by_horizon.json"
OUTPUT_RUN_INFO_JSON = "train_models/global/runs_info/gam_split_2_run_info.json"

MODEL_DIR = "models/models_gam_split_2"
...
def main():
    ...
    run_t0 = time.time()
    print(">>> [GAM Tuned - Split 2] Loading CSV...")
    ...
    for h in HORIZONS:
        ...
        # Train final pe tot TRAIN (<=2024H1)
        ...
        # save model
        model_path = os.path.join(MODEL_DIR, f"gam_split_2_h{h}.pkl")
    ...
    print("\n=== Sample of Results (Global GAM Tuned - Split 2) ===")
