...
OUTPUT_METRICS_PATH = "results/gam_dl_split_2_metrics_tuned.csv"
OUTPUT_PREDS_PATH = "results/gam_dl_split_2_predictions_sample.csv"
OUTPUT_BEST_PARAMS_JSON = "train_models/global/gam_dl_split_2_best_params_by_horizon.json"
OUTPUT_RUN_INFO_JSON = "train_models/global/runs_info/gam_dl_split_2_run_info.json"

MODEL_DIR = "models/models_gam_dl_split_2"
...
def main():
    ...
    for h in HORIZONS:
        ...
        # save model
        model_path = os.path.join(MODEL_DIR, f"gam_dl_h{h}.pkl")
