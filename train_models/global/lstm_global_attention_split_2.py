...
VAL_START = pd.Timestamp("2024-04-01 00:00:00", tz="UTC")
VAL_END   = TRAIN_END
...
# IMPORTANT: batch mai mic => mult mai puțin risc de OOM
BATCH_SIZE = 256
EPOCHS = 50
LR = 5e-4
PATIENCE = 6
...
# Output paths (standardized with _split_2 suffix)
METRICS_CSV = "results/lstm_attention_split_2_metrics.csv"
PRED_SAMPLE_CSV = "results/lstm_attention_split_2_predictions_sample.csv"
TRAINING_HISTORY_DIR = "train_models/history/lstm_attention_split_2_histories"
MODELS_DIR = "models/lstm_attention_split_2_models"
SCALERS_JSON = "train_models/scalers/lstm_attention_split_2_scalers.json"
RUN_INFO_JSON = "train_models/global/runs_info/lstm_attention_split_2_run_info.json"
...
def main():
    ...
    # Split (split_2: train 2023-2024H1, test 2024H2)
    ...
    for h in HORIZONS:
        ...
        # Save model
        model_path = os.path.join(MODELS_DIR, f"lstm_attention_split_2_h{h}.keras")
    ...
    # (Ca să păstrezi compatibilitatea cu output-ul tău original)
