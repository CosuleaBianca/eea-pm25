...
OUTPUT_METRICS_PATH = "results/gam_dl_metrics_tuned.csv"
OUTPUT_PREDS_PATH = "results/gam_dl_predictions_sample.csv"
OUTPUT_BEST_PARAMS_JSON = "train_models/global/gam_dl_best_params_by_horizon.json"
OUTPUT_RUN_INFO_JSON = "train_models/global/runs_info/gam_dl_run_info.json"

MODEL_DIR = "models/models_gam_dl"
