...
OUTPUT_METRICS_PATH = f"results/gam_dl_metrics_tuned_exclude_{EXCLUDE_COUNTRY}.csv"
OUTPUT_PREDS_PATH = f"results/gam_dl_predictions_sample_exclude_{EXCLUDE_COUNTRY}.csv"
OUTPUT_BEST_PARAMS_JSON = f"train_models/global/gam_dl_best_params_by_horizon_exclude_{EXCLUDE_COUNTRY}.json"
OUTPUT_RUN_INFO_JSON = f"train_models/global/runs_info/gam_dl_run_info_exclude_{EXCLUDE_COUNTRY}.json"

MODEL_DIR = f"models/models_gam_dl_exclude_{EXCLUDE_COUNTRY}"
...
# Speed knobs (reduced for memory constraints)
...
def main():
    ...
    run_t0 = time.time()
    print(">>> [GAM Tuned - Leave-One-City-Out] Loading CSV...")
    ...
    print("\n=== Sample of Results (Global GAM DL - Leave-One-City-Out) ===")
